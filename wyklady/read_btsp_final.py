...
if __name__ == "__main__":
    # A B C D E F G H
    T = [("A", 1, 3), ("B", 2, 1), ("C", 6, 1), ("D", 8, 2),
         ("E", 9, 4), ("F", 7, 6), ("G", 5, 4), ("H", 3, 5)]
    bitonicTSP(T)

    # Wrocław,  Kraków,  Warszawa,  Gdańsk
    T = [["Wrocław", 0, 2], ["Warszawa", 4, 3],
         ["Gdańsk", 2, 4], ["Kraków", 3, 1]]
    bitonicTSP(T)

    # F,  D,  B,  C,  E,  A
    T = [["A", 0, 2], ["B", 4, 3], ["C", 2, 4], ["D", 3, 1], ["E", 1, 3],["F",0.5,-2]]
    bitonicTSP(T)

    # I,  J,  H,  D,  E,  G,  F,  C,  B,  A,  I
    T = [['A', 0, 2], ['B', 1, 1], ['C', 4, 1], ['D', 5, 3], ['E', 6, 3], ['F', 8, 3], ['G', 7, 4], ['H', 2, 4],['I', 0.5, 2.5], ['J', 1.5, 3.5]]
    bitonicTSP(T)